...
client.on('voiceStateUpdate', async(oldState, newState) => {
    try {
        ...
        if (voiceChannelPerGuild[newState.guild.id] && voiceChannelPerGuild[newState.guild.id]['voice_channel_id'] === newState.channelID) {
            ...
            let voiceChannel = await member.guild.channels.cache.get(voiceChannelPerGuild[newState.guild.id]['voice_channel_id']);
            let textChannel = await member.guild.channels.cache.get(voiceChannelPerGuild[newState.guild.id]['text_channel_id']);
