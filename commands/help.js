...
client.on('message', async(message) => {
    if (!message.author.bot && message.channel.type === "text" && message.content.startsWith(`${prefix}help`)) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(
                `
This bot's main purpose is to work as a voice message recorder and send voice messages to make communication between members easy, when they haven't time or possibility to write a lot. \nThere are two interchangeable ways to record a voice message: with \`!v record\`, in a temporary bot-made voice channel.
\n\n\n
⏺   \`!v record\` - Creates a voice channel in the first position of the server channel list. When you join this voice channel, the bot will join too and record your voice. When you leave, then, the bot sends your voice message in the channel where you sent this command.
\n\n
